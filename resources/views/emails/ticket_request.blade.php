...
@section('content')
	<h2 style="text-align:center;
		 margin-bottom:30px;">Thanks for purchasing ticket.</h2>
	...
	@if($ticket)
		...
		<br/><br/>
	@endif
	<p>Your request for approval has been sent to concern person.It should be processed soon and you will get notification regarding it.<p>
	<br><br>
	Best Regards<br/>

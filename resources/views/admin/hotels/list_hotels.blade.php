    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>Hotels List
                </div>
            </div>
            <div class="portlet-body">
                <div class="table-toolbar">
                    ...
                    </div>					<div class="btn-group">						<select class="form-control" id="filterstatus">								<option value="">All Hotels</option>							<option value="1">Active Hotels</option>							<option value="0">Inactive Hotels</option>													</select>                    </div>
                </div>
...
columnDefs: [{
    ...
    targets: [4],
    render: function(data, type, row) {
        return '<a href="' + base_url + '/admin/hotel-edit/' + data + '" class="btn btn-sm default"><i class="fa fa-edit"></i></a><a href="' + base_url + '/admin/hotel-delete/' + data + '" class="btn btn-sm default"><i class="fa fa-times" onclick="return confirm('+"'Are you sure?'"+')"></i></a>';
    }
},
	...
	$(document).on( 'click', '.btn_change_approve', function () {
        ...
        var id=$(this).attr('id');
		 ...
		 if(confirm($msg)){
			$.ajax({
				type: "POST",
				url: '{{ route("ajax_hotel_change_status") }}',

    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>Add Hotel
                </div>
            </div>
            <div class="portlet-body">
                {{ Form::open(array('route'=>'hotel-add','files'=>true,'id' => 'hotelForm', 'onsubmit'=>'return validate()' )) }}
                    <div class="row hotel">
                        <div class='col-sm-4'>                       
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('hotel_location', '', ['class' => 'form-control','placeholder' => 'Hotel Location']) }}                    
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::textarea('hotel_description', '', ['size' => '30x5','class' => 'form-control','placeholder' => 'Hotel Description']) }}
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {{ Form::radio('hotel_privacy', 'PUBLIC', true, array('id'=>'public','class'=>'radio-btn')) }}
                                {{ Form::label('private', 'Private') }}
                                {{ Form::radio('hotel_privacy', 'PRIVATE', false, array('id'=>'private','class'=>'radio-btn')) }}                      
                            </div>
                        </div>
                    </div>
 ...
 <script>
    ...
    $( "#hotelForm" ).validate( {
        rules: {
            ...
            country_id: "required",			hotel_description: "required",
        ...
        messages: {
            hotel_name: "Please enter carnival name",
            hotel_location: "Please enter your location",

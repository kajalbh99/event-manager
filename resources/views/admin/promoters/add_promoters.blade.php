...
@stop
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>Add Promoter
                </div>
            </div>
            <div class="portlet-body">
                {{ Form::open(array('route'=>'promoter-add','files'=>true,'id' => 'userForm','onsubmit'=>'return validate()')) }}
                <div class="row event">
                        ...
                        <div class='col-sm-4'>                       
							...
							<div class="form-group">
                                ...
                                {{ Form::text('routing_number', '', ['class' => 'form-control','placeholder' => 'Routing number','id'=>'routing_number']) }}
                            </div>
                            <div class="form-group">
								{{ Form::label('account_number', 'Account 	Number',['class' => 'form-label']) }}
								{{ Form::text('account_number', '', ['class' => 'form-control','placeholder' => 'Account number','id'=>'account_number']) }}
							</div>
                        </div>
 ...
 <script>
	...
	jQuery.validator.addMethod("validate_account", function(value, element, params) {

    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-edit"></i>Promoters List
                </div>
            </div>
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="btn-group">
                    <a href="{{ route('promoter-add') }}">
                            <button id="sample_editable_1_new" class="btn green">
                                Add New <i class="fa fa-plus"></i>
                            </button>
                        </a>                       
                    </div>					<div class="btn-group">						<select class="form-control" id="filterstatus">								<option value="">All Promoters</option>							<option value="1">Active Promoters</option>							<option value="0">Inactive Promoters</option>													</select>                    </div>
                </div>
...
$(document).ready(function() {
    var table = $('#userTable').DataTable({
        ...
        columnDefs: [{
            ...
            targets: [11],
            render: function(data, type, row) {
                return '<a href="' + base_url + '/admin/promoter-edit/' + data + '" class="btn btn-sm default"><i class="fa fa-edit"></i></a><a href="' + base_url + '/admin/user-delete/' + data + '" class="btn btn-sm default" onclick="return confirm('+"'Are you sure?'"+')"><i class="fa fa-times"></i></a>';
            }
        },

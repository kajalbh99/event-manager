    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body">
                {{ Form::open(array('route'=>['user-edit',$user_details->id],'files'=>true,'id' => 'userEditForm','method'=>'post','onsubmit'=>'return validate()')) }}
                <div class="row event">
                    ...
                    <div class="row event">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                {{ Form::radio('type', 'admin', ($user_details->type == "admin"), array('id'=>'admin','class'=>'radio-btn')) }}
                                {{ Form::label('user', 'User') }}
                                {{ Form::radio('type', 'user', ($user_details->type == "user"), array('id'=>'user','class'=>'radio-btn')) }}
                                {{-- Form::label('promoter', 'Promoter') }}
                                {{ Form::radio('type', 'promoter', ($user_details->type == "promoter"), array('id'=>'promoter','class'=>'radio-btn')) --}}
                            </div>
                        </div>
        ...
        </div>		<div class="portlet box blue">            <div class="portlet-title">                <div class="caption">                    <i class="fa fa-edit"></i>Users Friends                </div>            </div>            <div class="portlet-body">                                <div class="row event">					<div class="col-sm-12">						<div class="form-group">							<div class="table-toolbar">								<div class="btn-group">									<div class="btn-group">										<select class="form-control" id="filterstatus">												<option value="">All Friends</option>											<option value="1">Active Friends</option>											<option value="0">Inactive Friends</option>																					</select>									</div>                      								</div> 							</div>							<div class="form-body">								<div class="form-group">									<table class="table table-striped table-hover table-bordered datatable">										<thead>											<tr>												<th>													Id												</th>												<th>													Name												</th>												<th>													 Email												</th>												<th>													User Name											   </th>											   <th>													 Mobile												</th>												<th>													Date of birth											   </th>																								<th>													Gender												</th>												<th>													Type												</th>												<th class="select-filter">													Active												</th>																							</tr>										</thead>										<tbody>																					</tbody>									</table>								</div>							</div>						</div>					</div>                </div>                                </div>        </div>		<div class="portlet box blue">            <div class="portlet-title">                <div class="caption">                    <i class="fa fa-edit"></i>Users Gallery                </div>            </div>            <div class="portlet-body">                                <div class="row event">					<div class="col-sm-12">						<div class="form-group">						@forelse($user_details->gallery as $gid=>$gimage )							<div class="col-sm-2">								<div class="form-group">									<div style="" class="form-body">										<div class="form-group">											<a id="" class="removegalleryimages"  style="position: absolute; left: 0; top: 0;" data-user_id = "{{$user_details->id}}" data-gallery_id = "{{$gimage->id}}">												<img src="{{asset('public/img/cross.png')}}" class="removeImage" alt="Remove this image" align="top"> 											</a>											<img class="banner img-responsive" src="{{asset('public/uploads/user_photo_gallery/'.$user_details->id.'/'.$gimage->user_gallery_image)}}">                                                                                                                         										 </div>									</div>								</div>							</div>						@empty							<p>No image found</p>                        @endforelse						</div>					</div>                </div>                                </div>        </div>
 ...
 <script>
    ...
    $(document).ready(function() {
        $('.datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route("ajax_user_friends",$user_details->id) }}',
